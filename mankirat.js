...
const song = [
   {
      id: '1',
      SongName: `Pakistan<br>
        <div class"subtitle">Mankirat Aulakh</div>`,
      poster: "1.png"
   },
   {
      id: '2',
   ...
   {
      id: '14',
      SongName: `Mahindra Thar <br>
        <div class"subtitle">Mankirat Aulakh</div>`,
      poster: "14.png"
   },
   {
      id: '15',
      SongName: `Pyar Da Saboot <br>
        <div class"subtitle">Mankirat Aulakh</div>`,
      poster: "15.png"
   },
   {
...
Array.from(document.getElementsByClassName('PlaylistPlay')).forEach((element) => {
   element.addEventListener('click', (e) => {
      ...
      music.src = `mankirat/${index}.mp3`;
      download_music.href = `mankirat/${index}.mp3`;
